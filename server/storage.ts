...
export class MemStorage implements IStorage {
  ...
  constructor() {
    ...
    this._createExerciseType({
      ...
      notes:
        "Keep your knees tracking over your toes, maintain a neutral spine",
      category: "Legs",
    });
    ...
    this._createExerciseType({
      ...
      notes:
        "Start with the bar over mid-foot, keep the bar close to your body",
      category: "Back",
    });
  }
  ...
  async getWorkouts(): Promise<Workout[]> {
    return [...this.workouts.values()].sort(
  ...
  async deleteWorkout(id: number): Promise<boolean> {
    ...
    const exercisesToDelete = [...this.exercises.values()].filter(
      (e) => e.workoutId === id,
    );
  ...
  async createExerciseType(
    exerciseType: InsertExerciseType,
  ...
  async getExerciseHistory(
    ...
    const allExercises = [...this.exercises.values()].filter(
  ...
  async getLatestExerciseSet(
    ...
    const sortedExercises = allExercises
      ...
      .sort((a, b) => {
        ...
        return (
          new Date(workoutB.date).getTime() - new Date(workoutA.date).getTime()
        );
      });
